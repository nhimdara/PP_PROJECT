...
const inputCls = {
  ...
  transition: "all 0.15s", fontFamily: "'DM Sans', sans-serif", color: "#111827"
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "2.25rem", fontWeight: 700, color: "#111827", lineHeight: 1.2 }}>Settings</h1>
              ...
              <div className="content-panel p-3 sticky top-24">
                ...
                <div className="mt-3 pt-3" style={{ borderTop: "1px solid #f3f4f6" }}>
                  <button onClick={onLogout}
                    className="sidebar-btn hover:bg-red-50 w-full">
                    <div className="flex items-center gap-3">
                ...
                {activeTab === "profile" && (
                  <div>
                    ...
                    <div className="space-y-5 max-w-2xl">
                      <div className="flex items-center gap-5 p-4 rounded-2xl" style={{ background: "#fafafa", border: "1px solid #f0f0f8" }}>
                        <img
                          src={user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(settings.name)}&background=6366f1&color=fff&size=128`}
                          alt={settings.name}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <Field label="Full Name">
                          <input className="sett-input" type="text" value={settings.name} onChange={e => handleChange("name", e.target.value)} />
                        </Field>
                        ...
                        <Field label="Email Address">
                          <input className="sett-input" type="email" value={settings.email} onChange={e => handleChange("email", e.target.value)} />
                        </Field>
                        <Field label="Phone Number">
                          <input className="sett-input" type="tel" value={settings.phone} onChange={e => handleChange("phone", e.target.value)} />
                        </Field>
                        <Field label="Location">
                          <input className="sett-input" type="text" value={settings.location} onChange={e => handleChange("location", e.target.value)} />
                        </Field>
                        <Field label="Occupation">
                          <input className="sett-input" type="text" value={settings.occupation} onChange={e => handleChange("occupation", e.target.value)} />
                        </Field>
                      </div>
                      <Field label="Bio">
                ...
                {activeTab === "privacy" && (
                  <div>
                    ...
                    <div className="space-y-5 max-w-2xl">
                      ...
                      <div className="sett-card space-y-4">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Profile Visibility</p>
                    ...
                    <div className="space-y-5 max-w-2xl">
                      <div className="sett-card space-y-4">
                        ...
                        <Field label="New Password">
                          <input className="sett-input" type="password" value={settings.newPassword} onChange={e => handleChange("newPassword", e.target.value)} placeholder="••••••••" />
                        </Field>
                        <Field label="Confirm New Password">
                          <input className="sett-input" type="password" value={settings.confirmPassword} onChange={e => handleChange("confirmPassword", e.target.value)} placeholder="••••••••" />
                        </Field>
                      </div>

                      <div className="sett-card space-y-4">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Security Options</p>
                        <ToggleSwitch label="Two-Factor Authentication" description="Add an extra layer of security via authenticator app" checked={settings.twoFactorAuth} onChange={() => handleToggle("twoFactorAuth")} />
                        <ToggleSwitch label="Login Alerts" description="Get notified of new sign-ins to your account" checked={settings.loginAlerts} onChange={() => handleToggle("loginAlerts")} />
                      </div>
                      ...
                      <div className="danger-zone">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-red-700 mt-0.5 leading-relaxed">Once deleted, all your data is permanently removed and cannot be recovered.</p>
                          </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-5 max-w-2xl">
                      ...
                      <Field label="Billing Address">
                        <input className="sett-input" type="text" value={settings.billingAddress} onChange={e => handleChange("billingAddress", e.target.value)} />
                      </Field>
                    ...
                    <div className="space-y-5 max-w-2xl">
                      ...
                      <Field label="Download Quality">
                        <select className="sett-select" value={settings.downloadQuality} onChange={e => handleChange("downloadQuality", e.target.value)}>
                          <option value="hd">HD (1080p) — Best quality, larger files</option>
